...
### Example
[![](images/plot.png "The test represented by the green line becomes more efficient over time, because it has been optimized across different measurements.")](/example/index.html)
This example graph is generated by enabling the [`visualization` feature](#visualization). In this line plot, the test represented by the green line becomes more energy efficient over time. To view all visualizations generated by the [`visualization` feature](#visualization), please visit the [example report](/example/index.html).
